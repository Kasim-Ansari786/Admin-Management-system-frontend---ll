    ...
    <div className="space-y-6">
      ...
      >
        <TabsList className="grid w-full grid-cols-7">
          ...
          <TabsTrigger value="players">Student Management</TabsTrigger>
          <TabsTrigger value="payments">Payments</TabsTrigger>
          <TabsTrigger value="coaches">Teacher Management</TabsTrigger>
          <TabsTrigger value="settings">Academy Settings</TabsTrigger>
          <TabsTrigger value="Assigned">Assign Student</TabsTrigger>
          <TabsTrigger value="venues">Center Management</TabsTrigger>
        </TabsList>
          ...
          <Card className="shadow-card">
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
              <div className="space-y-1">
                ...
                <CardDescription>
                  Manage all registered student and their details
                </CardDescription>
              </div>
