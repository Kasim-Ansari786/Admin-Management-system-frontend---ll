    ...
    <Card className="space-y-4">
      ...
      <CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-[#d67e7a] hover:bg-[#c56d69] text-white font-semibold py-2 px-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-sm"
            disabled={
              isLoading || !passwordValidation.isValid || !passwordsMatch
            }
          >
            {/* //<UserPlus className="h-5 w-5" />{" "} */}
            {/* This is the icon from your image */}
